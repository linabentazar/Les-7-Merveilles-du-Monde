...
const articles = {
    gizeh: {
        ...
        content: `
            ...
            <p>Même après des millénaires, le plateau de Gizeh continue de fasciner. Entre pyramides majestueuses et secrets enfouis sous la pierre, de nouvelles recherches révèlent chaque année des informations inédites sur la vie, le travail et l’ingénierie des anciens Égyptiens.
</p>
            ...
            <p>Cependant, le Conseil suprême des antiquités égyptiennes a précisé qu’aucune structure n’a encore été archéologiquement confirmée, et que seule une cavité a été repérée à faible profondeur.
</p>
            <p>Parallèlement, une étude géochimique menée par le CNRS a mis en évidence une contamination en cuivre et arsenic vieille de plus de 5 000 ans, liée à l’utilisation d’outils lors de la construction, offrant de nouvelles pistes sur les techniques et conditions de travail des bâtisseurs.
</p>
            ...
            <p>→ L’accès aux zones souterraines est limité pour des raisons de sécurité et de conservation, ce qui ralentit les fouilles officielles.
</p>
            <p>→ Les technologies modernes, comme les radars de pénétration et les analyses géochimiques, ouvrent de nouvelles pistes pour explorer Gizeh sans toucher aux structures historiques.
</p>
            <p>→ Ces découvertes permettent de relier passé et présent, en montrant que même les sites les plus célèbres peuvent encore révéler des secrets après plus de 4 500 ans.
</p>
    ...
    taj: {
        ...
        content: `
			...
			<p>Le monument mythique situé à Agra, en Inde, est aujourd’hui au cœur d’un vaste et coûteux chantier de conservation. Érigé entre 1631 et 1648 par l’empereur moghol Shâh Jahân en mémoire de son épouse Mumtaz Mahal, le Taj Mahal subit les conséquences du temps, de la pollution et des intempéries.
</p>

			
            <h3>Des défis techniques et environnementaux</h3>

			<p>→ En septembre 2024, de fortes pluies ont provoqué des infiltrations d’eau sous le dôme du Taj Mahal : trois points de fuite ont été identifiés par des drones et un scanner LiDAR.
</p>
			<p>→ Les minarets et d’autres parties de la structure montrent désormais des signes d’humidité et de détérioration des joints. Des échafaudages ont été installés pour intervenir sans perturber l’accès des visiteurs (le site reste ouvert).
</p>
			<p>→ Le marbre blanc, matériau emblématique du mausolée, est menacé : jaunissement, dépôt de particules polluantes, croissance de mousses ou algues. La restauration consiste notamment à appliquer une « boule de pâte à glaise » sur les surfaces pour absorber les impuretés avant rinçage.
</p>
			<p>→ Le nombre de visiteurs est un facteur important : jusqu'à 70 000 personnes pouvaient visiter le site sur certaines journées, ce qui crée une pression supplémentaire sur les fondations et les revêtements. Afin de limiter l’afflux, un plafond journalier de 40 000 visiteurs a été annoncé
</p>
			
			 <h3>Pourquoi un tel chantier ?</h3>
			 
			 <p>Le Taj Mahal, chef-d’œuvre architectural et site touristique majeur, nécessite une restauration pour préserver son dôme, ses façades et ses jardins pour les générations futures. Le chantier combine techniques traditionnelles et innovations modernes (drones, LiDAR, analyses chimiques) et prend en compte des enjeux plus larges : qualité de l’air, gestion de l’eau et contrôle du tourisme de masse.
</p>
    ...
    climat: {
        ...
        content: `
		   ...
		   <p>Les paysages naturels qui nous émerveillent : montagnes, forêts, glaciers, récifs coralliens ne sont pas éternels. Le réchauffement climatique, la montée des eaux, l’érosion et les phénomènes extrêmes menacent aujourd’hui plusieurs « merveilles naturelles ». Il est temps de regarder ce qui se joue au-delà du spectacle, pour comprendre ce que l’on pourrait perdre.</p>
            ...
            <h3>Des menaces multiples
</h3>
		   <p>→ Dans les Alpes françaises, le glacier de la Mer de Glace a perdu près de 1 km de longueur et 160 m d’épaisseur au cours des 35 dernières années, avec une perte de volume estimée à un tiers en vingt ans.
</p>
		   <p>→ Le Grande Barrière de corail en Australie subit des épisodes de blanchissement à répétition : plus de la moitié de ses coraux auraient disparu depuis 1995 sous l’effet du réchauffement des eaux. 
</p>
		   <p>→ Selon des évaluations, le changement climatique est désormais la menace principale pour les sites du patrimoine naturel mondial : jusqu’à 20 % des sites culturels et naturels africains sont menacés par l’élévation du niveau de la mer et l’érosion côtière.
</p>

            <h3>Pourquoi cela devrait nous alerter
</h3>
		   <p>Ces phénomènes illustrent la fragilité des écosystèmes face à des changements rapides. Quand un glacier fond ou qu’un récif blanchit, c’est tout un milieu naturel qui se transforme, avec des conséquences sur la faune, la flore, le tourisme et l’économie locale. Les communautés humaines qui dépendent de ces sites en subissent également les effets. Perdre une « merveille naturelle », c’est aussi voir disparaître une partie de notre patrimoine commun et de notre capacité à s’émerveiller.
</p>
